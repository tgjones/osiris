...
namespace Osiris.Graphics.Effects
{
	public abstract class ShaderEffect
	{
		...
		public ShaderFragment GetShaderFragment()
		{
			return ((ContentManager) ServiceProvider.GetService(typeof(ContentManager))).Load<ShaderFragment>(GetShaderFragmentName());
		}

		protected abstract string GetShaderFragmentName();
